...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl border border-stone-200 overflow-hidden mt-3">
        @if($lesson->isDocument())
            <div class="bg-stone-100" style="height: 70vh;">
        ...
        <div class="p-6">
            ...
            @endif
            @if($lesson->isDocument() && $lesson->documentUrl())
                <a href="{{ $lesson->documentUrl() }}" target="_blank" download class="inline-block mt-4 px-4 py-2 bg-red-600 text-white text-sm rounded-lg">⬇ Unduh Dokumen</a>
            @endif
        </div>
    </div>
</div>

        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-stone-100">
                    @forelse($contents as $c)
                        <tr>
                            ...
                            <td class="px-4 py-2.5 text-right text-stone-700">
                                ...
                                @if($c->latestSnapshot)<span class="block text-[10px] text-stone-400">{{ $c->latestSnapshot->captured_on->format('d M') }}</span>@endif
                            </td>
                    ...
                    @empty
                        <tr><td colspan="{{ $canManage ? 6 : 5 }}" class="px-4 py-10 text-center text-stone-400 text-sm">Belum ada konten bulan ini.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>

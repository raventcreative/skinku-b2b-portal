...
@php
    ...
    $badge = function ($override, $eff) use ($rp) {
        if ($override !== null) return '<span class="inline-block px-1.5 py-0.5 rounded-sm bg-indigo-50 text-indigo-700 text-[10px] font-semibold">Override: '.e($rp($override)).'</span>';
        return '<span class="inline-block px-1.5 py-0.5 rounded-sm bg-stone-100 text-stone-500 text-[10px] font-semibold">Ikut Master</span>';
    };
@endphp
<div class="space-y-4">

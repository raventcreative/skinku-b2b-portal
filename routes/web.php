...
Route::middleware(['auth', 'role'])->group(function () {
    ...
    Route::middleware('permission:kol.view')->group(function () {
        ...
        Route::middleware('permission:kol.affiliate.view')->group(function () {
            ...
            Route::middleware('permission:kol.affiliate.manage')->group(function () {
                ...
                Route::post('/kol-gapok/join-date', [KolGapokController::class, 'saveJoinDate'])->name('kol-gapok.join-date');
                Route::post('/kol-gapok/payment', [KolGapokController::class, 'addPayment'])->name('kol-gapok.payment');
    ...
    Route::middleware('permission:manage_ecommerce_chat')->group(function () {
        ...
        Route::post('/ecom-chat/{conversation}/flag', [EcomChatController::class, 'toggleFlag'])->name('ecom-chat.flag');
    });
